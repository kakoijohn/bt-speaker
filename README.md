...
```bash
sudo -i
bash <(curl -s https://raw.githubusercontent.com/kakoijohn/bt-speaker/master/install.sh)
```

For details refer to the comments in the [install script](https://github.com/kakoijohn/bt-speaker/blob/master/install.sh).
